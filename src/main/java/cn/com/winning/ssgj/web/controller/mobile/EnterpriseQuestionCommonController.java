...
public class EnterpriseQuestionCommonController extends BaseController{
    ...
    public String siteQuestionList(Model model, Long userId, String serialNo,Integer status,Integer searchType,String searchText,Integer userType,Integer priority) throws ParseException {
