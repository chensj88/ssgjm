...
@WebServiceClient(name = "LBEBusinessWebService", 
                  wsdlLocation = "http://203.110.176.178:9083/service/LBEBusiness?wsdl",
...
public class LBEBusinessWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://203.110.176.178:9083/service/LBEBusiness?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://203.110.176.178:9083/service/LBEBusiness?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
