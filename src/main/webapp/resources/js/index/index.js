jQuery(function($) {
   /* $('.easy-pie-chart.percentage').each(function(){
    ...
    var content = '<h1>用户管理<small><i class="icon-double-angle-right"></i>用户信息</small></h1>';
    $('.page-header').empty();
    $(content).appendTo($('.page-header'));
    $('#navlist li a').on('click',function(e){
        ...
        if(parenTitle){
            var content = '<h1>'+ parenTitle.trim()+'<small><i class="icon-double-angle-right"></i>'+title+'</small></h1>';
            pageHeader.empty();
            $(content).appendTo(pageHeader);
