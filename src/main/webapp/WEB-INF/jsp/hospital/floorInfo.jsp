...
<div class="row text-center" id="queryScope">
    <form class="form-inline col-xs-12 col-sm-12 col-md-12 col-lg-12" >
        <div class="input-group col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <label class="col-sm-6 control-label text-right" for="serialQName">客户名称：</label>
            <div class="col-sm-4">
                <input type="text" class="form-control input-sm" id="serialQName" data-provide="typeahead"/>
            </div>
        </div>
        <input type="hidden" id="serialQNo">
        <div class="input-group col-xs-3 col-sm-3 col-md-3 col-lg-3">
            <label class="col-sm-6 control-label text-right" for="floorQName">楼层名称：</label>
            <div class="col-sm-4">
                <input type="text" class="form-control input-sm" id="floorQName"/>
            </div>
        </div>
...
<!--模态框  -->
<div class="modal fade" id="floorsModal" tabindex="-1" role="dialog" aria-labelledby="formModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width:450px;">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">楼层信息</h4>
            </div>
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        <form class="form-horizontal col-lg-6 col-md-6 col-sm-6 col-xs-6" role="form" id="floorsForm">
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="serialName">客户名称</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="serialName" name="serialName" placeholder="请输入客户名称" data-provide="typeahead">
                                </div>
                            </div>
                            <input type="hidden" id="serialNo" name="serialNo">
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="floorName">楼层名称</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="floorName" name="floorName" placeholder="请输入楼层名称">
                                </div>
                            </div>
...
<script type="text/javascript" src="<%=basePath%>resources/js/hospital/floors.js"></script>
</html>
