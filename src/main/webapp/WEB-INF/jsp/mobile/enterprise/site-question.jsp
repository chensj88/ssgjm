...
<html>
	...
	<body>
		...
		<div class="site-question">
			<a href="<%=basePath%>mobile/siteQuestionInfo/addAndUpdate.do?serialNo=${hospcode}&userId=${work_num}">
				<div class="site-add">
					<i class="iconfont icon-plus"></i>站点问题汇报
				</div>
			</a>
		...
		<script type="text/javascript">
			$(function(){
                ...
                $("input[name=allocateUser]").bind('propertychange',function(){
                    alert('值已改变');
                })
			})
