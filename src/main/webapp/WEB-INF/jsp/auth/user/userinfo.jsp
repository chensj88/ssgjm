...
<head>
    ...
    <link rel="stylesheet" href="/resources/bootstrap/css/bootstrap-treeview.min.css">
    <base href="<%=basePath%>">
...
<script type="text/javascript" src="/resources/bootstrap/js/bootstrap-treeview.min.js"></script>
