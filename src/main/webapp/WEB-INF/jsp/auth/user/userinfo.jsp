    ...
    <div class="row text-center" id="queryScope">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 div-style text-center">
                <label class="col-sm-4 form-text" for="cName">姓名：</label>

                    <input type="text" class="input-style" id="cName"/>

            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 div-style text-center">
                <label class="col-sm-4 form-text" for="userCard">员工号：</label>

                    <input type="text" class="input-style" id="userCard"/>

            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 div-style text-center">
                <label class="col-sm-4 form-text" for="telephone">手机号：</label>

                    <input type="text" class="input-style" id="telephone"/>
                        ...
                        <div class="row">
                            <form class="form-horizontal col-lg-6 col-md-6 col-sm-6 col-xs-6" role="form" id="userForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="yhmc" name="yhmc"
                                               placeholder="请输入用户名称">
                                    </div>
                                </div>
