                    ...
                    <div class="row">
                        <form class="form-horizontal col-lg-6 col-md-6 col-sm-6 col-xs-6" role="form" id="moduleForm">
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="moduleName">功能名称</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="moduleType">功能类型</label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="moduleType" id="moduleType"></select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="moduleAction">功能路径</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="moduleDesc">功能描述</label>
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" id="moduleDesc" name="moduleDesc"
                                           placeholder="功能信息描述">
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <button class="btn btn-primary" id="savemodule" type="submit">保存</button>
