    ...
    <div class="row" id="queryScope">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 div-style text-center">
                <label class="col-sm-4 form-text" for="interQName">接口名称:</label>
                <input type="text" class="input-style" id="interQName"/>
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 div-style text-center">
                <label class="col-sm-4 form-text" for="interQCode">接口代码:</label>
                    ...
                    <div class="container">
                        <div class="row">
                            <form class="form-horizontal col-lg-6 col-md-6 col-sm-6 col-xs-6" role="form"
                                  id="interFaceInfoForm">
                                <div class="form-group" style="display:none;" id="code">
                                    <label class="col-sm-4 control-label">接口代码:</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" readonly="readonly" id="interCode"
                                               name="interCode" placeholder="请输入接口代码">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">接口名称:</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="interName" name="interName"
                                               placeholder="请输入接口名称">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="refProductName"
                                               name="refProductName"
