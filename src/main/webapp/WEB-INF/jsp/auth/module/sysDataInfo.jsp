...
<div class="container-fluid">
    <div class="row" id="queryScope">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 div-style text-center">
                <label class="col-sm-4 form-text" for="tableQName">表名：</label>
                <input type="text" class="input-style" id="tableQName"/>
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 div-style text-center">
                <label class="col-sm-4 form-text" for="tableQCnName">表中文名：</label>
                <input type="text" class="input-style" id="tableQCnName"/>
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 div-style text-center">
                        ...
                        <div class="row">
                            <form class="form-horizontal col-lg-6 col-md-6 col-sm-6 col-xs-6" role="form"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="tableAttention"
                                               name="tableAttention"
                                               placeholder="请输入注意事项">
                                    </div>
                                </div>
