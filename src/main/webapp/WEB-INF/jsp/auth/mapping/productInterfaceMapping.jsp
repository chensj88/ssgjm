...
<div id="toolbarA">
    ...
    <div class="columns pull-right search-input"><input class="form-control" type="text" placeholder="请输入接口名称或编号" id="infoA"></div>
</div>
<div id="toolbarB">
    ...
    <div class="columns pull-right search-input"><input class="form-control" type="text" placeholder="请输入接口名称或编号"  id="infoB"></div>
</div>
<%--弹出框--%>
...
<script type="text/javascript" src="<%=basePath%>resources/js/auth/mapping/productInterface.js"></script>
</html>
