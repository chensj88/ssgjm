...
<<<<<<< HEAD
                        ...
                        <li><a href="#"><i class="icon-double-angle-right"></i>第三方接口类型信息</a></li>
...
=======
                        ...
                        <li><a href="#"><i class="icon-double-angle-right"></i>基础数据信息</a></li>
                        <li><a href="#"><i class="icon-double-angle-right"></i>流程信息</a></li>
                        <li><a href="#"><i class="icon-double-angle-right"></i>接口信息</a></li>
...
>>>>>>> 0cda393f446c298e237fc4125e4f971a277302fd
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li><a href="#"><i class="icon-double-angle-right"></i>合同系统信息</a></li>
                        <li><a href="#"><i class="icon-double-angle-right"></i>系统模块信息</a></li>
                        <li><a href="#"><i class="icon-double-angle-right"></i>系统基础数据信息</a></li>
                        <li><a href="#"><i class="icon-double-angle-right"></i>模块流程信息</a></li>
                        <li><a href="#"><i class="icon-double-angle-right"></i>模块接口接口信息</a></li>
                        <li><a href="#"><i class="icon-double-angle-right"></i>模块软硬件信息</a></li>
                        <li><a href="#"><i class="icon-double-angle-right"></i>模块单据&报表信息</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li id="s_uer" ><a href="#"><i class="icon-double-angle-right"></i>用户信息</a></li>
